from .views import Register, Login, Logout, DeleteUser, UpdateUser, UpdateUserPassword, Jobsites, getJobsiteByID
...
urlpatterns = [
    ...
    path('updateUserPassword/<username>', UpdateUserPassword.as_view()),
